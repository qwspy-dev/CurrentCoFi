...
export default withApi((request) => ok(request, {
  ...
  "x-current-cofi": {
    liveResourceGroups: [
      ...
      "builder-integration-manifest", "integration-conformance", "portable-integration-certificates", "public-network-proof", "verified-testnet-traction", "public-campaign-proof-explorer", "privacy-safe-campaign-evidence", "public-grant-dossier",
