...
export default withApi((request) => ok(request, {
  ...
  paths: {
    ...
    "/project-token-proof": { get: { summary: "Verify an arbitrary Arc ERC-20 reserve and fully funded walletless campaign" } },
  ...
  "x-current-cofi": {
    liveResourceGroups: [
      ...
      "builder-integration-manifest", "integration-conformance", "portable-integration-certificates", "public-network-proof", "verified-testnet-traction", "public-campaign-proof-explorer", "privacy-safe-campaign-evidence", "account-free-reviewer-demo", "non-mutating-verified-replay", "public-project-token-proof", "arbitrary-erc20-testnet-evidence", "public-grant-dossier",
