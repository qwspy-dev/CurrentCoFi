...
export const webhookEventTypes = [
  ...
  "quality.assessed",
  "escrow.created",
  "escrow.approve-token",
  "escrow.fund",
  "escrow.submit",
  "escrow.approve",
  "escrow.dispute",
  "escrow.resolve",
  "escrow.request-cancellation",
  "escrow.accept-cancellation",
  "escrow.refund-expired",
  "checkout.created",
  "checkout.paid",
  "checkout.refunded",
  ...
  "treasury.proposal_created",
  "treasury.proposal_approved",
  "treasury.proposal_rejected",
  "treasury.payment_executed",
  "campaign.cancelled",
  "campaign.refunded",
