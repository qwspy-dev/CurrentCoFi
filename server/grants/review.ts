...
async function packageFromEvidence(report: EvidenceReport) {
  ...
  const packageBody = {
    ...
    proof: {
      ...
      escrowAgreements: numberFrom(totals, "escrowAgreements"),
      fundedEscrowAgreements: numberFrom(totals, "fundedEscrowAgreements"),
      settledEscrowMilestones: numberFrom(totals, "settledEscrowMilestones"),
