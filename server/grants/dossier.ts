...
const shipped = [
  ...
  { id: "agent-runtime", label: "Installable policy-bound MCP server", detail: "Eleven MCP tools, read-only defaults, scoped credentials, exact approval phrases, spending limits, signed requests, treasury proposal access, and honest Arc settlement evidence." },
