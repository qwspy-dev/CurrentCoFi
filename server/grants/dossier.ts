...
const shipped = [
  ...
  { id: "agent-runtime", label: "Installable policy-bound MCP server", detail: "Thirteen MCP tools, read-only defaults, scoped credentials, exact approval phrases, spending limits, signed requests, treasury and giveaway access, and honest Arc settlement evidence." },
