...
const shipped = [
  ...
  { id: "active-wallet", label: "Noncustodial active wallet controls", detail: "Recipients can move USDC or inspected project tokens through an exact Circle approval, with live balance checks and Arc receipts returning to the unified account record." },
  ...
  { id: "discovery-attribution", label: "Funded opportunity discovery and conversion", detail: "Only open, fully funded public opportunities are indexed. Anonymous daily impressions and opens remain separated from reservations, entries, submissions, confirmed claims, activations, and retention evidence." },
  { id: "acquisition-intelligence", label: "Project-scoped acquisition evidence", detail: "Private project analytics connect daily-deduplicated Discovery attention to participation, confirmed Arc settlement, and signed activation outcomes while keeping every evidence class distinct." },
  { id: "community-bounties", label: "Prize-backed community bounties", detail: "Projects lock USDC or project-token prizes in an Arc campaign vault, collect privacy-preserving work proof, and give one selected contributor a gas-sponsored walletless claim." },
  { id: "verifiable-giveaways", label: "Verifiable walletless giveaways", detail: "Projects lock a USDC or project-token prize, accept encrypted one-identity entries, attribute referrals, and publish a reproducible commit-reveal winner proof before delivering one walletless claim." },
  { id: "community-treasury", label: "Transparent community treasury", detail: "Projects publish category budgets and spending proposals while payments remain inside the configured Circle wallet until an owner or admin approves and signs the exact Arc transfer. Public pages expose masked recipients and transaction receipts without leaking identity data." },
