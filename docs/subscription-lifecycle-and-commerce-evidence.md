...
Evidence schema `current-evidence-v18` includes aggregate merchant checkout, recurring USDC, prize-backed community-bounty, privacy-safe community-treasury proof, verifiable giveaway evidence, and walletless launch-vesting proof:
