...
Evidence schema `current-evidence-v16` includes aggregate merchant checkout, recurring USDC, prize-backed community-bounty, and privacy-safe community-treasury proof:
