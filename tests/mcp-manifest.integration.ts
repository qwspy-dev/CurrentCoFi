...
assert.equal(manifest.tools.filter((tool) => tool.kind === "read").length, 5);
...
console.log("MCP manifest verified: canonical digest, seven tools, read-only default, explicit write approvals, and honest settlement boundary.");
