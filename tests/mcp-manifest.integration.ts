...
assert.equal(manifest.tools.filter((tool) => tool.kind === "read").length, 8);
...
console.log("MCP manifest verified: canonical digest, thirteen tools, read-only default, explicit write approvals, and honest settlement boundary.");
