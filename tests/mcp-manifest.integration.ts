...
assert.equal(manifest.tools.filter((tool) => tool.kind === "read").length, 6);
...
console.log("MCP manifest verified: canonical digest, nine tools, read-only default, explicit write approvals, and honest settlement boundary.");
