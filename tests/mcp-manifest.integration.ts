...
assert.equal(manifest.tools.filter((tool) => tool.kind === "read").length, 7);
...
console.log("MCP manifest verified: canonical digest, eleven tools, read-only default, explicit write approvals, and honest settlement boundary.");
