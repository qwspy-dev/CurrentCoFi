...
assert.equal(manifest.tools.filter((tool) => tool.kind === "read").length, 9);
...
console.log("MCP manifest verified: canonical digest, fifteen tools, read-only default, explicit write approvals, and honest settlement boundary.");
